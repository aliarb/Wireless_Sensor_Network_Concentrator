...
linker.cmd: package/cfg/rfExamples_pem3.xdl
	$(SED) 's"^\"\(package/cfg/rfExamples_pem3cfg.cmd\)\"$""\"C:/Users/arabal/workspace_v7/zrfWsnConcentrator_CC2650_LAUNCHXL_TI_Synch/.config/xconfig_rfExamples/\1\""' package/cfg/rfExamples_pem3.xdl > $@
